(define (script-fu-shrink-stroke inImage inDrawable inShrinkth inColor inLoop inWidth inDirname) 
    (let* (
           (theImage inImage)
...
(script-fu-menu-register "script-fu-shrink-stroke" "<Image>/Filters/Script-Fu")
